...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='bdchain.conf'
CONFIGFOLDER="/root/.bdchain"
COIN_DAEMON='bdchaind'
COIN_CLI='bdchain-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/bdchainteam/bdccore/releases/download/1.0.0.0/BDC-DAEMON.zip'
